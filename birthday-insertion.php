...
$sql2 = null;
$sql3 = null;
foreach (glob("pre_made/*/branded/birthday*.html") as $filename) {
  ...
  if($type === 'Birthday 1 Week'){
    $subject = $birthdayRows[1][2];
    $preHeader = $birthdayRows[1][3];
    $voucher = '0';
  } else if($type === 'Birthday 3 Weeks'){
    $subject = $birthdayRows[2][2];
    $preHeader = $birthdayRows[2][3];
    $voucher = '0';
  } else if($type === 'Birthday 6 Weeks'){
    $subject = $birthdayRows[3][2];
    $preHeader = $birthdayRows[3][3];
    $voucher = '1';
  }
...
$append = "birthday-1-week-insert";
sendToFile($sql1, $append);

$append = "birthday-3-weeks-insert";
sendToFile($sql2, $append);

$append = "birthday-6-weeks-insert";
