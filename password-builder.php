...
foreach(glob("*/templates/*_branded.html") as $filename){
  ...
  $passwordRows = getData($email, $serverName);
  ...
  $heading = str_replace('Heading goes here', $passwordRows[3], $heading);
